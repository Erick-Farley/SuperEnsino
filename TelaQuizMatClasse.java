...
public class TelaQuizMatClasse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_quiz_mat_classe);

        //Initialize the view
        init();

        //Initialize the database
        final QuestoesMatClasse dbAdapter=new QuestoesMatClasse(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(TelaQuizMatClasse.this, TelaResultado.class);
