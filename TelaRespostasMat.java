...
public class TelaRespostasMat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_respostas_mat);
        ...
        final QuestoesMat dbAdapter=new QuestoesMat(this);
        ...
        adapter = new CustomAdapter(TelaRespostasMat.this, R.layout.lists_row,
                originalValues);
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.tvCans.setText("Resposta correta é: "+originalValues.get(position).get(KEY_CANS)
                    .toString());
            viewHolder.tvYouans.setText("Sua resposta: "+originalValues.get(position)
