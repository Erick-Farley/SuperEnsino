...
public class TelaQuizLetras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_quiz_letras);

        //Initialize the view
        init();

        //Initialize the database
        final QuetoesLetras dbAdapter=new QuetoesLetras(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(TelaQuizLetras.this, TelaResultado.class);
