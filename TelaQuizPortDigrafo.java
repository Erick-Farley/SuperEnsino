...
public class TelaQuizPortDigrafo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_quiz_port_digrafo);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(TelaQuizPortDigrafo.this, TelaResultado.class);
