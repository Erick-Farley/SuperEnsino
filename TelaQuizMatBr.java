...
import java.util.List;
    ...
    public class TelaQuizMatBr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final QuestoesMatBr dbAdapter=new QuestoesMatBr(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(TelaQuizMatBr.this, TelaResultado.class);
