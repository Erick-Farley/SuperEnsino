...
public class TelaQuizEmprego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_quiz_emprego);

        //Initialize the view
        init();

        //Initialize the database
        final QuestoesEmprego dbAdapter=new QuestoesEmprego(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(TelaQuizEmprego.this, TelaResultado.class);
