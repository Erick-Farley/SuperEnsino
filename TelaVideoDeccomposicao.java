...
public class TelaVideoDeccomposicao extends AppCompatActivity {
    VideoView videoad;
    MediaController mediaController;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tela_video_deccomposicao);

        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        videoad = (VideoView)findViewById(R.id.videoad);
        mediaController = new MediaController(this);

        String videopath2 = "android.resource://com.example.pipeline.superensino3/raw/decomposicao_numerica";
