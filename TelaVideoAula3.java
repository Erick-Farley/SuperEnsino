...
public class TelaVideoAula3 extends AppCompatActivity {
    VideoView videoad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_video_aula3);

        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        videoad = (VideoView)findViewById(R.id.videoad);
        mediaController = new MediaController(this);

        String videopath2 = "android.resource://com.example.pipeline.superensino3/raw/questao_3";
