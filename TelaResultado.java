...
public class TelaResultado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAnsweredInfo.setText("Voce respondeu corretamente "+score+" de "+totalQs+" questões");

        float percentage=(score*100)/totalQs;

        if (percentage>=80 && percentage<=100){
            t.setText("Parabéns voce é nota 10!!!");
        }else if(percentage>=70 && percentage<=79){
            t.setText("Ótima Pontuação");
        }else if(percentage>=60 && percentage<=69){
            t.setText("Boa Pontuação");
        }else if(percentage>=50 && percentage<=59){
            t.setText("Pontuação Média!");
        }else if(percentage>=33 && percentage<=49){
            t.setText("Pontuação um pouco baixa, vamos estudar mais!");
        }else{
            t.setText("Pontuação muito baixa, voce precisa estudar mais");
        }
        ...
        btnDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent disc = new Intent(TelaResultado.this, TelaMateriaRef.class);
                startActivity(disc);
                finish();
            }
        });
        ...
        btnViewAnswer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vIntent=new Intent(TelaResultado.this,TelaRespostasMat.class);
