...
public class TelaQuizMatDecomposicao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tela_quiz_mat_decompo);
        //Initialize the view
        init();

        //Initialize the database
        final QuestoesMatDecomposicao dbAdapter=new QuestoesMatDecomposicao(this);
            ...
            public void onClick(View v) {
                ...
                if(answer!=null){
                    ...
                    if(questionId<dbAdapter.rowCount()){
                        ...
                        Intent intent = new Intent(TelaQuizMatDecomposicao.this, TelaResultado.class);
