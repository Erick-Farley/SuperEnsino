...
/**
 * Created by erick on 20/04/2017.
 */

public class QuestoesPortBR extends SQLiteOpenHelper {
    ...
    public QuestoesPortBR(Context context) {
    ...
    private void addQuestions()
    {
        ...
        Question q1=new Question(" “o consumo mundial de água triplicou em 1950.” A palavra destacada significa:","aumentou três vezes.", "diminuiu.", " dobrou.", "aumentou trinta vezes. ","aumentou trinta vezes. ");
        this.addQuestion(q1);

        Question q2=new Question("No\ttrecho\t“É\tna    camada    mais    externa \t da   superfície   terrestre” a\texpressão sublinhada indica:","causa.", "finalidade. ", "lugar", "tempo","lugar");
        this.addQuestion(q2);
